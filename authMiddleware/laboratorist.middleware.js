...
const laboratoristModel = require('../Models/laboratorist.model');
...
passport.use(
    ...
    new localStrategy(
      ...
      async (username, email, password, done) => {
        try {
          const user = await laboratoristModel.create({username, email, password });
  ...
  passport.use(
    ...
    new localStrategy(
      ...
      async (username, password, done) => {
        try {
          const user = await laboratoristModel.findOne({ username });
